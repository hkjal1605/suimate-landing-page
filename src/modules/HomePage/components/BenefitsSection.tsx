...
const BenefitsSection = () => {
  return (
    <div className="flex flex-col px-[5%] bg-black-1000 items-start justify-center w-full py-[150px] gap-5">
      ...
      <div className="flex w-full gap-5 h-[350px] justify-center items-stretch">
        <div className="benefits-card-1 w-full flex-[1.2] flex flex-col items-start justify-start gap-4 p-6">
          ...
          <p className="text-base text-black-100">
            Informed Decisions: Review historical performance, risk levels, and
            portfolio composition to make choices that align with your risk
        ...
        <div className="benefits-card-2 w-full flex-[1] flex flex-col items-start justify-start gap-4 p-6">
          ...
          <p className="text-base text-black-100">
            Verification: Verify the legitimacy of new coins by analyzing holder
            activities and investment levels.
          </p>
          <p className="text-base text-black-100">
      ...
      <div className="flex w-full gap-5 justify-center h-[350px] items-stretch">
        <div className="benefits-card-3 w-full flex-[1] flex flex-col items-start justify-start gap-4 p-6">
          ...
          <p className="text-base text-black-100">
            Strategic Growth: Improve your trading approach by learning from the
            experts, minimizing hasty moves.
          </p>
        </div>
